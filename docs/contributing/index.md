...
To add a new target language (dialect) to codegen, follow the step-by-step guide in
[Adding a Dialect](04_adding_dialect.html).

## Testing the Code Generator

For an explanation of the two-layer test model, utilities, naming conventions, and
worked examples for all dialects (including Python subprocess tests), see
[Testing the Code Generator](05_testing_codegen.html).

## Patching Codegen Dialects

When fixing TypeScript errors in generated files, read
