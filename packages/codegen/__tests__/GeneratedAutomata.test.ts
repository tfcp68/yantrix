import { actionsDictionary, GeneratedAutomata, statesDictionary } from './fixtures/GeneratedAutomata_generated.js';
import { beforeEach, describe, expect, test, vitest } from 'vitest';

let automata: GeneratedAutomata;

describe('Codegen output', () => {
	describe('GeneratedAutomata', () => {
		let automata = new GeneratedAutomata();
		const payload = {};
