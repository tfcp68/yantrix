...
const reducer = {74979334: (prevContext, payload, functionDictionary) => {
	...
	65: (prevContext, payload, functionDictionary) => {
				...
				return {sum: (function(){
						...
						return functionDictionary.get('sum')((function(){
						if(payload !== null && payload['numbers'] !== undefined && payload['numbers'] !== null) {
	...
	average: (function(){
						const boundValue = (function(){
						return functionDictionary.get('avg')((function(){
						if(payload !== null && payload['numbers'] !== undefined && payload['numbers'] !== null) {
							return payload['numbers']
						}
							else {
	...
	maxValue: (function(){
						const boundValue = (function(){
						return functionDictionary.get('max')((function(){
						if(payload !== null && payload['numbers'] !== undefined && payload['numbers'] !== null) {
							return payload['numbers']
						}
							else {
