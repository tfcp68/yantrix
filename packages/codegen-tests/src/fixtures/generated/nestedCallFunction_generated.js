...
const reducer = {74979334: (prevContext, payload, functionDictionary) => {
	...
	65: (prevContext, payload, functionDictionary) => {
				...
				return {a: (function(){
						...
						return functionDictionary.get('mult')(functionDictionary.get('avg')((function(){
						if(payload !== null && payload['list'] !== undefined && payload['list'] !== null) {
							return payload['list']
						}
							else {
								return null
						...
						if(payload !== null && payload['count'] !== undefined && payload['count'] !== null) {
