...
import { builtInFunctions, kek2, add } from '@yantrix/functions';
				...
				return {a: (function(){
						if(prevContext !== null && prevContext['a'] !== undefined && prevContext['a'] !== null) {
							return prevContext['a']
								...
								return functionDictionary.get('lol2')()
							}
					}())}
			},
...
functionDictionary.register('kek2', function() {
				return (function() {
				const func = functionDictionary.get('add');
				return func(1, 2);
			})();
			});
functionDictionary.register('lol2', function() {
				return (function() {
				const func = functionDictionary.get('kek2');
				return func();
			})();
			});
			const actionsMap = {
