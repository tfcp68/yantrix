...
const reducer = {74979334: (prevContext, payload, functionDictionary) => {
	...
	65: (prevContext, payload, functionDictionary) => {
				...
				return {result: (function(){
						...
						return functionDictionary.get('round')(functionDictionary.get('mult')(functionDictionary.get('add')((function(){
						if(payload !== null && payload['a'] !== undefined && payload['a'] !== null) {
							return payload['a']
						}
							else {
								return null
						...
						if(payload !== null && payload['b'] !== undefined && payload['b'] !== null) {
							return payload['b']
						}
							else {
								return null
							}
					}())),functionDictionary.get('div')((function(){
						if(payload !== null && payload['c'] !== undefined && payload['c'] !== null) {
							return payload['c']
						}
							else {
								return null
						...
						if(payload !== null && payload['d'] !== undefined && payload['d'] !== null) {
							return payload['d']
						}
							else {
								return null
