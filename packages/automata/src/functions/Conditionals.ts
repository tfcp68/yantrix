...
export function _if(condition: Boolean, true_value: any, false_value: any): any {
	return condition === true ? true_value : false_value;
}

export function _case(cases: [condition: Boolean, return_value: any][]): any {
...
export function _coalesce(...expressions: any[]): any {
