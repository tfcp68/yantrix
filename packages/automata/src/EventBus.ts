...
import { TAutomataBaseEventType, TAutomataEventStack, TBaseClassConstructor, TEventBusHandler } from './types/index.js';
...
>() {
	return <TBase extends TBaseClassConstructor>(Proto: TBase) =>
