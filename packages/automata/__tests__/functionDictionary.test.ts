...
describe('functionDictionary', () => {
	...
	describe('constructor', () => {
		it('returns an instance of FunctionDictionary', () => {
			expect(dict).toBeInstanceOf(FunctionDictionary);
		});
		it('returns an instance of AbstractBaseClass', () => {
			expect(dict).toBeInstanceOf(AbstractBaseClass);
		});
		...
		it('assigns a unique Correlation ID per instance', () => {
			const other = new FunctionDictionary();
			expect(dict.correlationId).not.toBe(other.correlationId);
		});
	});
