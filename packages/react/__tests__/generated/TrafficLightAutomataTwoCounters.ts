...
return [EventBus, automatas];
  ...
  "Yellow": "Yellow"
	...
	82033: (prevContext, payload, functionDictionary, automata) => {
				...
				return {counter: (function(){
			const boundValue = (function(){
						return functionDictionary.get('if')(functionDictionary.get('isEqual')(functionDictionary.get('currentActionName')(),'Switch'),functionDictionary.get('inc')((function(){
						if(prevContext !== null && prevContext['counter'] !== undefined && prevContext['counter'] !== null) {
							return prevContext['counter']
						}
							else {
	...
	counter2: (function(){
			const boundValue = (function(){
						return functionDictionary.get('if')(functionDictionary.get('isEqual')(functionDictionary.get('currentActionName')(),'Switch_1'),functionDictionary.get('inc')((function(){
						if(prevContext !== null && prevContext['counter2'] !== undefined && prevContext['counter2'] !== null) {
							return prevContext['counter2']
						}
							else {
...
export class TrafficLightAutomataTwoCounters extends GenericAutomata {
    ...
    static id = 'TrafficLightAutomataTwoCounters_1764928130210';
